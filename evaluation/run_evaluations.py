    ...
    async def evaluate_fact_checker(self) -> Dict[str, Any]:
        ...
        for case in evalset["eval_cases"]:
            ...
            try:
                ...
                results["failed"] += 1
                results["details"].append({"eval_id": eval_id, "status": "ERROR", "error": str(e)})
    ...
    async def evaluate_argument_analyzer(self) -> Dict[str, Any]:
        ...
        for case in evalset["eval_cases"]:
            ...
            try:
                ...
                expected_fallacies_line = [
                    line for line in expected_response.split("\n") if "FALLACIES:" in line.upper()
                ][0]
