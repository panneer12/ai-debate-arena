...
class MetricsCollector:
    ...
    def track_action(self, agent_name: str, action_type: str, start_time: float, 
                     input_text: str = "", output_text: str = "", error: Optional[Exception] = None):
        """
        ...
        if error:
            error_details = f"{agent_name} error in {action_type}: {str(error)}\n{traceback.format_exc()}"
