...
ANALYSIS: Both sides agree on the economic problems but differ on solutions."""
    ...
    history = [
        DebateMessage(from_agent="Conservative", role="Debater", content="We need jobs", type=MessageType.ARGUMENT),
        DebateMessage(from_agent="Progressive", role="Debater", content="We need stability", type=MessageType.ARGUMENT)
    ]
