...
def test_add_and_retrieve_messages(temp_memory_dir):
    ...
    msg1 = DebateMessage(from_agent="Agent A", role="Debater", content="Hello", type=MessageType.OPENING_STATEMENT)
    msg2 = DebateMessage(from_agent="Agent B", role="Debater", content="Hi", type=MessageType.OPENING_STATEMENT)
...
def test_save_and_load_debate(temp_memory_dir):
    ...
    msg = DebateMessage(from_agent="Agent A", role="Debater", content="Test", type=MessageType.ARGUMENT)
